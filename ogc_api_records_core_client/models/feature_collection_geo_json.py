...
T = TypeVar("T", bound="FeatureCollectionGeoJSON")
...
class FeatureCollectionGeoJSON:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        feature_collection_geo_json = cls(
            type_=type_,
            features=features,
            links=links,
        ...
        feature_collection_geo_json.additional_properties = d
        return feature_collection_geo_json
