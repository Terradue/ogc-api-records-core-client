...
from ..models.multipoint_geo_json_type import MultipointGeoJSONType

T = TypeVar("T", bound="MultipointGeoJSON")
...
class MultipointGeoJSON:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = MultipointGeoJSONType(d.pop("type"))
        ...
        multipoint_geo_json = cls(
            type_=type_,
            coordinates=coordinates,
        )

        multipoint_geo_json.additional_properties = d
        return multipoint_geo_json
