...
from ..models.linestring_geo_json_type import LinestringGeoJSONType

T = TypeVar("T", bound="LinestringGeoJSON")
...
class LinestringGeoJSON:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = LinestringGeoJSONType(d.pop("type"))
        ...
        linestring_geo_json = cls(
            type_=type_,
            coordinates=coordinates,
        )

        linestring_geo_json.additional_properties = d
        return linestring_geo_json
